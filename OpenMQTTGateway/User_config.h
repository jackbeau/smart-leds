...
#define mqtt_server ""
#define mqtt_user "" // not compulsory only if your broker needs authentication
#define mqtt_password "" // not compulsory only if your broker needs authentication
...
#define ota_hostname "RF_NODE"
#define ota_password "TheCellMC56?"
