...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "terrasse" //change this to whatever you want to call your device
...
const char* light_state_topic = "house/terrasse";
const char* light_set_topic = "house/terrasse/set";
